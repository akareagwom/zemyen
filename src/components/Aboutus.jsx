...
const AboutUs = () => {
    return (  
        <div className="">
            <section class="pt-6 overflow-hidden bg-gray-50 md:pt-0 sm:pt-16 2xl:pt-16">
        ...
        <div class="grid items-center grid-cols-1 md:grid-cols-2">
            <div>
                ...
                <p class="mt-4 text-xl text-gray-600 md:mt-8">
                    ...
                    <br class="block sm:hidden" />Ask me on <Link href="#" title="" class="transition-all duration-200 text-sky-500 hover:text-sky-600 hover:underline">Twitter</Link>
                </p>
            </div>
