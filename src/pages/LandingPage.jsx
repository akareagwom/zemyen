    ...
    return ( 
        <div className="relative">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <section className="brightness-90  w-80 mt-[120px] ml-6 flex flex-col items-center rounded justify-center md:mt-12  md:ml-7 text-center  lg:w-sized  lg:mt-36 ">
                    <h1 className="text-3xl lg:text-6xl text-[#4169e1]">ZEMYEN STUDIOS</h1>
                    <p className="text-white text-[10.5px] md:text-[11px]">
                   ...
                   <Link to="/Contact"><button className=" bg-[#4169e1] h-8 w-32 rounded mt-6 text-slate-50">BOOK NOW</button></Link> 
                </section>
            </div>
        </div>
     );
