    ...
    return ( 
        <div className="relative">
            ...
            <div className="absolute inset-0">
                ...
                <section className="brightness-90 w-80 mt-24 ml-10 flex flex-col items-center rounded justify-center md:mt-12  md:ml-7 text-center  lg:w-sized  lg:mt-36 ">
                    <h1 className="text-3xl lg:text-6xl text-orange-400">ZEMYEN STUDIOS</h1>
                    <p className="text-white text-tiny md:text-medium">
