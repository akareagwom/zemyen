    ...
    return ( 
        <div className="relative overflow-hidden">
           ...
           <div className="absolute inset-0">
                ...
                <div className="md:ml-32 bg-black rounded-3xl md:w-3/4 md:justify-center md:items-center h-4/5 opacity-50 md:flex text-orange-400">
                    <div className="mb-6 md:p-16">
                        <h1 className="text-6xl">ZEMYEN STUDIOS </h1>
                    </div>
                    <div className="md:w-4/5 md:mr-3 h-44 scrollbar scrollbar-thumb-orange-400 scrollbar-track-orange-100">
